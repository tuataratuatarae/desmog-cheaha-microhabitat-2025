...
compHab2 = glmmTMB(habBin ~ Species + (1|StrmID), data = pointsSealComparison, family = "binomial")

summary(compHab2)

tab_model(compHab2)

nullComp2 = glmmTMB(habBin ~ (1|StrmID), data = pointsSealComparison, family = "binomial")
